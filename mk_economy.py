...
def crawling():
    ...
    try:
        ...
        for page in range(1, MAX_PAGE + 1):
            ...
            list_url = "http://vip.mk.co.kr/newSt/news/news_list.php?p_page={}&sCode=125&termDatef=&search=&topGubun=".format(page)
            ...
            if response.status_code == 200:
                ...
                for row in rows:
                    ...
                    if response_content.status_code == 200:
                        ...
                        if content_html is None or content_html == '' or content_html == [] or content_html.select('#Titless') == []:
                            continue
