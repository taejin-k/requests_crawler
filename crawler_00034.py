...
SU_JIB_WON_ID = 34
MAX_PAGE = int(os.getenv('CATCHONDATA_1_MAX_PAGE', '3'))
ROW_PER_PAGE = int(os.getenv('CATCHONDATA_1_ROW_PER_PAGE', '20'))
...
def filter_01(row):
    content_url = 'http://www.sisafocus.co.kr' + row.select('div.list-titles.table-cell > a')[0].attrs['href']
    ...
    return content_url, title, reg_datetime, jag_seong_ja
...
def crawling():
    ...
    try:
        ...
        for page in range(1, MAX_PAGE + 1):
            ...
            list_url = "http://www.sisafocus.co.kr/news/articleList.html?view_type=total&page={}".format(page)
            ...
            if response.status_code == 200:
                ...
                for row in rows:
                    ...
                    content_url, title, reg_datetime, jag_seong_ja = filter_01(row)
